...
def task2():
    # schedule.every().day.at("09:30:30").do(cleanup_files, source_dir=cleanup_folder)
    schedule.every(10).seconds.do(cleanup_files, source_dir=cleanup_folder)
...
if __name__ == "__main__":
    ...
    cleanup_folder = "./backup_2023-08-28_09-42-01"
